...
public class PerfilArtista implements ActionListener{
	...
	/**
	 * Construtor da classe PerfilArtista, onde serão feitas atualizações em um Artista instanciado.
	 * Daqui também é possível deletar um Artista.
	 * O construtor pede um Artista "a", para exibir sua informações, um AcitonListener "confirmar" para definir o que acontece quando o JButton confirm for pressionado,
