...
/**
 * Nesta classe é programada a Tela que exibe as informações de uma Musica
...
public class MusicScreen {
	...
	/**
	 * Construtor da Classe MusicScreen, onde são exibidas as informações das Musicas cadastradas.
	 * O construtor pede uma Musica m, para exibir as informações na tela.
	 * @param m
	 * Recebe uma música para exibir suas informacoes.
	 */
