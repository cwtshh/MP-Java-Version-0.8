...
/**
 * Nesta classe é programada a Tela a tela principal do programa.
...
public class MainScreen implements ActionListener{
	 ...
	 * Daqui é possível pesquisar Musica, editar Perfil. Relacionados ao Ouvinte.
	 ...
	 * @param search
	 * Recebe um ActionListener que faz a função de Busca.
	 * @param edit
	 * Recebe um ActionListenerr que faz a função de edição de perfil.
	 * @param musicas1
	 * recebe um Array de musicas que serão exibidas na listagem.
	 * @param artistas
	 * Recebe um Array de Artistas que serão exibidos na listagem.
	 * @param dados
