...
public class PerfilOuvinte implements ActionListener{
	...
	/**
	 * Construtor da Classe PerfilOuvinte, onde serão feitas atualizações em um Ouvinte já instânciado.
	 * Daqui também é possível deletar o Ouvinte
	 * O construtor pede um ouvinte, um ActionListener "confirmar" que determina a ação a ser executada quando o JButton confirm é pressionado.
	 * Outro ActionListener "deletar" para quando o JButton delete é pressionado.
	 * @param o
	 ...
	 * @param deletar
	 * Recebe um ActionListener que confirma a exclusap do Ouvinte
	 */
