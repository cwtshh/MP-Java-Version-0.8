...
/**
 * Nesta classe é programada a Tela principal do programa.
 * IMPORTANTE! existem 2 tipos de MainScreen, a variantes MusicScreenArtist possui um botão para que um Usuario do tipo Artista possa Cadastrar uma música.
...
public class LoginForm implements ActionListener{
    ...
    /**
     * Construtor da classe LoginForm, onde o Usuario digita suas informações de login para entrar no programa.
     * O construtor pede um ActionListener "loginAction" que define a função do JButton logarButton, e outro ActionListener "regAction" que define a função do JButton regButton.
     * @param loginAction
     * Recebe um ActionListener que irá logar o usuario.
     * @param regAction
     * Recebe um ActionListener que irá abrir a tela de registro
     */
