...
/**
 * Nesta classe é programada a Tela na qual se efetua o Cadastro de uma Musica
...
public class MusicCadScreen implements ActionListener{
	...
	/**
	 * Construtor da Classe MusicCadScreen, onde será cadastrada uma Musica.
	 * @param confirmar
	 * O construtor pede um ActionListener "confirmar" para definir o que acontece quando o JButton confirm é pressionado.
	 */
