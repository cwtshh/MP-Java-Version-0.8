...
public class MusicScreenArtist implements ActionListener{
	...
	/**
	 * Construtor da classe MusicScreenArtista, onde será exibido as informações de uma Musica cadastrada.
	 * Daqui é póssivel editar e deletar uma música.
	 * O construtor pede uma Musica m para exibir suas informações e um ActionListener "edit" para definir o que acontece quando o JButton edit é pressionado.
	 * @param m
