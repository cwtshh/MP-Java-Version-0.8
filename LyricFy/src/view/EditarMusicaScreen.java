...
/**
 * Nesta classe é programada a Tela na qual é possivel efetuar edições em objetos da Classe Musica.
...
public class EditarMusicaScreen implements ActionListener{
	...
	/**
	 * Construtor da Classe EditarMusicaScreen, onde serão feitas alterações em Musicas já cadastradas.
	 * O construtor pede uma Musica, um ActionListener "confirmar" que define a função do JButton confirm, e outro ActionListener "deletar" que define a função do JButton delete.
	 * @param m
	 * Recebe uma musica
	 * @param confirmar
	...
	/**
	 * Determina a visibilidade da tela, caso false, a tela é descartada.
	 * @param a
