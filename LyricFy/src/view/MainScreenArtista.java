...
/**
 * Nesta classe é programada a Tela na qual é exibida as informações de uma Musica.
...
public class MainScreenArtista implements ActionListener{
	...
	/**
	 * Construtor da Classe MainScreenArtista, onde são exibidas as listagens.
	 * Daqui é possivel cadastras Musica, editar Musica, buscar Musica, editar perfil. Relacionados ao Artista.
	 * O construtor pede um ActionListener "search" que define o que acontece quando o JButton search é clicado.
	 * ActionListener cadMusica, para definir o que acontece quando o JButton editar é pressionado.
	...
	/**
	 * Determina a visibilidade da tela. Caso seja definida como false, a tela é descartada.
	 * @param a 
