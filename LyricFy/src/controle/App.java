...
/**
 * A classe App é a principal classe do Programa, onde todos os seus comportamentos estão. A classe App faz a comunicação entre os pacotes view e controle.
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(typeOfUser == 1) {
				for(Artista a: artistas) {
					if(email.equals(a.getEmail()) && senhaStr.equals(a.getSenha())) {
				...
				for(Ouvinte o : ouvintes) {
					if(email.equals(o.getEmail()) && senhaStr.equals(o.getSenha())) {
